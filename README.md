...
```bash
npm install @Im-notDev-barmodss/barmodssnew-Baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add @Im-notDev-barmodss/barmodssnew-Baileys@latest
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@Im-notDev-barmodss/barmodssnew-Baileys")
```
...
```javascript
const makeWASocket = require("@Im-notDev-barmodss/barmodssnew-Baileys").default;
const { useMultiFileAuthState } = require("@Im-notDev-barmodss/barmodssnew-Baileys");
...
```javascript
const makeWASocket = require("@Im-notDev-barmodss/barmodssnew-Baileys").default;
const { DisconnectReason, useMultiFileAuthState } = require("@Im-notDev-barmodss/barmodssnew-Baileys");
...
```javascript
const makeWASocket = require("@Im-notDev-barmodss/barmodssnew-Baileys").default;
const { makeInMemoryStore } = require("@Im-notDev-barmodss/barmodssnew-Baileys");
...
const { downloadMediaMessage, getContentType } = require("@Im-notDev-barmodss/barmodssnew-Baileys");
